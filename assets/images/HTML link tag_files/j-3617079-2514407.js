...
(function(){
    ...
    (function() {
    var p = "3617079", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3617079||'',
    guid:window.ftGUID_3617079||'',
    confID:window.ftConfID_3617079||'0',
    ftReturn: window.ftReturn_3617079||'',
    keyword:window.ftKeyword_3617079||'',
    ftId:window.ftId_3617079||'',
    ftImpId:window.ftImp3617079 && window.ftImp3617079.impID || '',
    campaignID: '104109',
    cID:'100890',
    pID:'3617079',
    creativeID:'2514407',
    exttrack:[],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=104109&sid=653&plc=3617079&num=&adid=&advid=&adsrv=29&btreg=3617079&btadsrv=flashtalking&crt=2514407&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src"],
    clickTags: ['http://servedby.flashtalking.com/click/8/104109;3617079;2514407;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display'],
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?131751310-3617079;2514407;',
    centreAd: true,
    width:300,
    height:250,
    adType:'altimage'.toLowerCase(),
    altimg:'http://cdn.flashtalking.com/xre/361/3617079/2514407/image/2514407.gif',
    viewableImpressionURL: 'http://servedby.flashtalking.com/imp/8/104109;3617079;202;pixel;DBM;DBMFY19CCPSPKWTopicUSPPWB300x250/?',
    stump: 'http://servedby.flashtalking.com',
    altimghref:'http://servedby.flashtalking.com/click/8/104109;3617079;2514407;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.adobe.com/creativecloud/plans.html?sdid=GZKZY1B7&mv=display',
    divID:'ftdiv3617079',
    altimgID:'ftalt3617079',
    alttext:'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp3617079 && parseInt(window.ftImp3617079.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m3617079') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3617079'),
    pageVisible: 'maybe',
...
//TA_1 min
//ftMinified
(function(b){var c=window["ftImp"+b.pID]&&window["ftImp"+b.pID].privacy;c&&"x"!==c||((new Image).src=b.replaceMacros("ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2035&ta_partner_did=[GUID]&ta_format=png",!0),"undefined"==typeof window.ftD9ResponseRegister&&(window.ftD9ResponseRegister=[]),window.ftD9ResponseRegister.push({getD9Id:function(){return window.ft_d9ID||""},d9Response:function(b){var a="";try{a=b.DeviceID[0]}catch(d){}"timeout"!=a&&a?this.getD9Id()||(window.ft_d9ID=a||"",this.getD9Id()&&(this.d9Response=function(){})):a="";a&&((new Image).src="ht"+"tps://tapestry.tapad.com/tapestry/1?ta_partner_id=2176&ta_partner_did="+a+"&ta_format=png")}}))}(ft3617079));
