...
(function(){
    ...
    (function() {
    var p = "3379536", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3379536||'',
    GUID:window.ftGUID_3379536||'99999999999',
    confID:window.ftConfID_3379536||'0',
    ftReturn: window.ftReturn_3379536||'',
    keyword:window.ftKeyword_3379536||'',
    ftId:window.ftId_3379536||'',
    imp:window.ftImp3379536,
    ftImpId:window.ftImp3379536 && window.ftImp3379536.impID || '',
    campaignID:'98328',
    cID:'93411',
    pID:'3379536',
    creativeID:'2550207',
    ...
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/8/98328;3379536;2550207;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.xfinity.com/learn/internet-service?dfaid=4053494&cmp=0&cid=4053494"],
    placementDescription:'FTCOMCASTBAUCENTRALDESKTOPNONSUB728x90',
    width:728,
    height:90,
    ...
    divID:'ftdiv3379536',
    phID:'ftpos3379536',
    frameID:'ftframe3379536',
    expID:'ftexpframe3379536',
    altImgID:'ftalt3379536',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/98328;3379536;2550207;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.xfinity.com/learn/internet-service?dfaid=4053494&cmp=0&cid=4053494',
    altImg:'http://servedby.flashtalking.com/imp/8/98328;3379536;204;gif;XfinityUS;FTCOMCASTBAUCENTRALDESKTOPNONSUB728x90/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/98328;3379536;271;pixel;XfinityUS;FTCOMCASTBAUCENTRALDESKTOPNONSUB728x90/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/337/3379536/2550207/js/j-3379536-2550207.js',
    file:'http://cdn.flashtalking.com/93411/2550207/DIGI_GM_DHV_OFFACQ_ENG_40BUC8ST113RAP218x12_GETNOW_NOOFF_HTML_728x90.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?132941473-3379536;2550207;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:true,
    segment:window.ftSegment_3379536||'',
    segmentList:window.ftSegmentList_3379536||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3379536 && window.ftImp3379536.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3379536')&&/^https:/.test(document.getElementById('ftscript_m3379536').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3379536'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3379536'],
        ['ftcfid', 'ftConfID_3379536'],
        ['fttime', 'ftTimestamp_3379536'],
        ['ftsection', 'ftSection_3379536'],
        ['ftcustom', 'ftCustom_3379536'],
        ['ft_id', 'ftId_3379536'],
        ['ftimpid','ftImp3379536', 'impID']
    ]
};
